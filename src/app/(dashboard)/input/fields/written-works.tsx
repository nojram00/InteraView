...
export default function WrittenWorksField() {
   ...
   const [writtenData, setWrittenData] = useState({
    ...
    if (mainInputRef.current) {
        mainInputRef.current.value = JSON.stringify(writtenData);
    }
    }, [writtenData]);
  ...
  return (
    <Fragment>
        ...
        <input ref={mainInputRef} type='hidden' name='written-data' value={JSON.stringify(writtenData)}/>
